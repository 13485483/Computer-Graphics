...
var Planet = {
    ...
    * */
    createNew: function (mass, shaftAngle, r, distanceToSun, Bspeed, Sspeed,map,BCycleCenter) {
        ...
        // 自转轴 和 轨道
        var axi = Planet.createLineStripe({color:0x00456e,
        ...
        planet.getLookPoint = function(){
         ...
         //  console.log("2"+this.position.applyMatrix4(Object.matrixWorld));
           console.log("3"+pos);
            console.log("4"+pos.applyMatrix4(subPlanet.matrixWorld));
            return pos;
        };
   ...
   /* createNew:function(){
    ...
    createNewWithShader : function(PlanetClass){
        ...
        var uniforms = {
            ...
            texture2:{type:'t',value: new THREE.TextureLoader().load("./images/sun_surface.png")}
        };
